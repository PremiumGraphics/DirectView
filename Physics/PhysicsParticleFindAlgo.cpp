...
ParticlePairVector PhysicsParticleFindAlgo::search1(const ParticleSPtrVector& particles, ParticleSPtrVector::const_iterator startIter, ParticleSPtrVector::const_iterator endIter, const float effectLengthSquared){
...
ParticlePairVector PhysicsParticleFindAlgo::search2(const ParticleSPtrVector& particles, ParticleSPtrVector::const_iterator startIter, ParticleSPtrVector::const_iterator endIter, const float effectLengthSquared)
{
	ParticlePairVector pairs;
...
void PhysicsParticleFindAlgo::createPairs(ParticleSPtrVector particles, const float effectLength)
{
	if( particles.empty() ) {
		return;
	}
