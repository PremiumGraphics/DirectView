...
TEST(Marching3dTest, Test)
{
	...
	EXPECT_EQ(Vector3d_<float>(1,1,1).getNormalized(), table[1].front().getNormal());
	EXPECT_EQ(Vector3d_<float>(0,1,1).getNormalized(), table[2].front().getNormal());
	...
	EXPECT_EQ(Vector3d_<float>(1,1,1).getNormalized(), table[10][0].getNormal());
	EXPECT_EQ(Vector3d_<float>(-1,-1,-1).getNormalized(), table[10][1].getNormal());

	EXPECT_EQ(Vector3d_<float>(1.0, -1.0, 1.0).getNormalized(), table[12][0].getNormal());

	EXPECT_EQ(Vector3d_<float>(1,0,1).getNormalized(), table[13][0].getNormal());
	EXPECT_EQ(Vector3d_<float>(1,0,1).getNormalized(), table[13][1].getNormal());
	EXPECT_EQ(Vector3d_<float>(-1,0,-1).getNormalized(), table[13][2].getNormal());
	EXPECT_EQ(Vector3d_<float>(-1, 0, -1).getNormalized(), table[13][3].getNormal());
