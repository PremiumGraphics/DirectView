#ifndef __CRYSTAL_UI_PARTICLE_DIALOG_H__
#define __CRYSTAL_UI_PARTICLE_DIALOG_H__
...
class ParticleDialog : public wxDialog
{
public:
	ParticleDialog(wxWindow* parent) :
	...
	void set(const Command::ParticleConfig<float>& config) {
