...
NormalRenderer::Location NormalRenderer::getLocations()
{
	NormalRenderer::Location location;
...
void NormalRenderer::render(const int width, const int height, const Param& param, const std::vector< std::vector<unsigned int> >& indices)
{
